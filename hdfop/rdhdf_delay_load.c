 ...
 */
FARPROC WINAPI rdhdfDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = rdhdfDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = rdhdfDelayLoadWin32FailureHook;
#endif
